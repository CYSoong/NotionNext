...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '三文鱼', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢胶片的Ui设计师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.sanwenyu.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '胶片, 博客,UI,设计,摄影', // 网站关键词 英文逗号隔开
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/model/haru/haru_01.model.json/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      name: '心做し',
      artist: '鹿乃',
      url: 'https://music.163.com/#/song?id=40915694',
      cover:
    ...
    }
     {
      name: '猫になりたい',
      artist: 'つじあやの',
      url: 'https://music.163.com/#/song?id=28461702',
      cover:
        'https://p1.music.126.net/cRCFlxZLkLHtEmRb9tCF-Q==/5825212604154216.jpg'
    }
  ],
